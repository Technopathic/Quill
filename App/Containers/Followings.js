...
import { ScrollView, StatusBar, AsyncStorage, View, Image, Dimensions, FlatList } from 'react-native'
...
class Followings extends React.Component {
 ...
 getFollowing = () => {
  ...
  {
    fetch('http://quill.technopathic.me/api/getFollowing/'+this.props.id+'?page='+this.state.nextPage+'&token=' + this.state.token, {
      headers:{
