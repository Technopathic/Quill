...
class EditProfile extends React.Component {
 ...
 getProfile = () => {
  ...
  updateProfile() {
    ...
    fetch('http://quill.technopathic.me/api/updateProfile/'+this.props.uid+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      },
        ...
        <ScrollView style={Styles.container}>
          ...
          <View>
            <Item>
              ...
              <Input placeholder='Name'  style={descBody} value={this.state.profileName} onChange={this.handleProfileName} selectionColor="#6441A4" underlineColorAndroid="#6441A4"/>
            </Item>
            <Item>
              <Icon active name='person' style={{fontSize:22, paddingLeft:5, paddingRight:5}} />
              <Input placeholder='Bio' style={descBody} value={this.state.profileDesc} onChange={this.handleProfileDesc} selectionColor="#6441A4" underlineColorAndroid="#6441A4"/>
            </Item>
            <Item>
              <Icon active name='web' style={{fontSize:22, paddingLeft:5, paddingRight:5}} />
              <Input placeholder='New Password' style={descBody} value={this.state.newPassword} onChange={this.handleNewPassword} selectionColor="#6441A4" underlineColorAndroid="#6441A4"/>
            </Item>
            <Item>
              <Icon active name='web' style={{fontSize:22, paddingLeft:5, paddingRight:5}} />
              <Input placeholder='Confirm Password' style={descBody} value={this.state.confirmPassword} onChange={this.handleConfirmPassword} selectionColor="#6441A4" underlineColorAndroid="#6441A4"/>
            </Item>
          </View>
