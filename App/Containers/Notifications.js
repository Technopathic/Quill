...
class Notifications extends React.Component {
 ...
 getNotifs = () => {
  fetch('http://quill.technopathic.me/api/getNotifs?token=' + this.state.token, {
    headers:{
  ...
  fetch('http://quill.technopathic.me/api/readNotifs?token=' + this.state.token, {
    headers:{
      'Authorization': 'Bearer ' + this.state.token
    }
  });
  ...
  deleteNotif(id, index, type)
  {
    ...
    fetch('http://quill.technopathic.me/api/deleteNotif/'+id+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
  ...
  acceptRequest(id, peerID, index)
  {
    var _this = this;
    var requests = this.state.requests;
    fetch('http://quill.technopathic.me/api/acceptRequest/'+id+'/'+peerID+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
  ...
  denyRequest(id, peerID, index)
  {
    var _this = this;
    var requests = this.state.requests;
    fetch('http://quill.technopathic.me/api/denyRequest/'+id+'/'+peerID+'?token=' + this.state.token, {
      method: 'POST',
      headers:{
        'Authorization': 'Bearer ' + this.state.token
      }
  ...
  renderTabs = () => {
    ...
    var reportTab = <Button style={tabStyle} onPress={() => this.changeTab(2)}><Text style={{color:'#FFFFFF'}}>Reports</Text></Button>;
    var reportActiveTab = <Button style={activeTab} onPress={() => this.changeTab(2)}><Text style={{color:'#FFFFFF'}}>Reports</Text></Button>;
    if(this.state.user.user.role != 1)
    {
      reportTab = <Text></Text>;
      reportActiveTab = <Text></Text>;
    }
    ...
    if(this.state.activeTab === 0)
    {
      return(
        <View>
          <View style={tabBar}>
            <Button style={activeTab} onPress={() => this.changeTab(0)}><Text style={{color:'#FFFFFF', fontWeight:'bold'}}>New</Text></Button>
            <Button style={tabStyle} onPress={() => this.changeTab(1)}><Text style={{color:'#FFFFFF'}}>Follows</Text></Button>
            {reportTab}
          </View>
          {this.renderNoNotif()}
          <List>
    ...
    else if(this.state.activeTab === 1)
    {
      return(
        <View>
          <View style={tabBar}>
            <Button style={tabStyle} onPress={() => this.changeTab(0)}><Text style={{color:'#FFFFFF'}}>New</Text></Button>
            <Button style={activeTab} onPress={() => this.changeTab(1)}><Text style={{color:'#FFFFFF', fontWeight:'bold'}}>Follows</Text></Button>
            {reportTab}
          </View>
    ...
    else if(this.state.activeTab === 2 && this.state.user.user.role == 1)
    {
      return(
        <View>
          <View style={tabBar}>
